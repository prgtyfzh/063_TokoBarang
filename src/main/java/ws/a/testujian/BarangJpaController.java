...
import ws.a.testujian.exceptions.NonexistentEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ws.a_testujian_jar_0.0.1-SNAPSHOTPU");
